...
public class ApoliceService {
    ...
    public ApoliceResponseDTO toResponseDTO(Apolice apolice) {
        ...
        return new ApoliceResponseDTO(
                ...
                apolice.getCliente().getEndereco().getBairro(),
                apolice.getCliente().getEndereco().getCep(),
                apolice.getCliente().getEndereco().getLocalidade(),
                apolice.getCliente().getEndereco().getLogradouro(),
                apolice.getCliente().getEndereco().getNumero(),
                apolice.getCliente().getEndereco().getUf(),
